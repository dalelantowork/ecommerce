...
<div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-black">Start your journey with <span class="text-blue-600">Dale Lanto</span></h1>
        <p class="mt-3 text-lg text-gray-800 dark:text-gray-700">Purchase wide varities of electronics products like Smartphones, Laptops, Smartwatches, Television and many more.</p>
        ...
        <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
          ...
          <div class="py-5">
            ...
            <div class="mt-5">
              <!-- Star -->
              <svg class="h-auto w-16 text-gray-800 dark:text-black" width="80" height="27" viewBox="0 0 80 27" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="py-5">
            ...
            <div class="mt-5">
              <!-- Star -->
              <svg class="h-auto w-16 text-gray-800 dark:text-black" width="110" height="28" viewBox="0 0 110 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
